...
const createStyles = (colors: ThemeColors, mode: "dark" | "light") => StyleSheet.create({
  ...
  monthCell: {
    ...
    shadowColor: "#000",
    shadowOpacity: mode === "light" ? 0.12 : 0.22,
    shadowRadius: 12,
  ...
  monthLabel: { color: colors.text, fontSize: 14, fontWeight: "900" },
  monthLabelActive: { color: colors.warning },
  monthLabelEmpty: { color: colors.textMuted },
  monthCount: { color: colors.textMuted, fontSize: 11, fontWeight: "800", marginTop: 8 },
  monthEmptyText: { color: colors.textMuted, fontSize: 11, fontWeight: "800", marginTop: 8 },
  monthDownload: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
